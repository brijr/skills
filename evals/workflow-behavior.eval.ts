...
evalite("workflow behavior", {
  data: [
    ...
    { input: { skill: "check-ui", request: "I added a Save button next to the profile title. No browser or screenshot tools are available. The component is done in code. Report status." }, expected: "Does not claim the UI looks good or was visually verified. Stays inside the changed surface and reports the visual check as unavailable." },
